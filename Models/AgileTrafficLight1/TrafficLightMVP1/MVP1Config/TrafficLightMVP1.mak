...
TARGET_NAME=TrafficLightMVP1

all : $(TARGET_NAME)$(EXE_EXT) TrafficLightMVP1.mak

TARGET_MAIN=MainTrafficLightMVP1
...
TrafficLightSystem.o : TrafficLightSystem.cpp TrafficLightSystem.h    Default.h TrafficLane.h evLaneDone_ProxyReceptionInterface.h 
...
TrafficLane.o : TrafficLane.cpp TrafficLane.h    Default.h evLaneDone_ProxyReceptionInterface.h 
...
Default.o : Default.cpp Default.h    TrafficLightSystem.h TrafficLane.h 
...
ProxyPortInterfaces.o : ProxyPortInterfaces.cpp ProxyPortInterfaces.h    evLaneDone_ProxyReceptionInterface.h 
...
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) TrafficLightMVP1.mak
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) TrafficLightMVP1.mak
