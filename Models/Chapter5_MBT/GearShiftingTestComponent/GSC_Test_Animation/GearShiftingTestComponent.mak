...
TARGET_NAME=GearShiftingTestComponent

all : $(TARGET_NAME)$(EXE_EXT) GearShiftingTestComponent.mak

TARGET_MAIN=MainGearShiftingTestComponent
...
Pegasus_Test_Architecture.o : Pegasus_Test_Architecture.cpp Pegasus_Test_Architecture.h    TestPkg.h MainComputingPlatform.h RiderInteraction.h RiderApplication.h GearControl.h ShiftLever.h DIButton.h evDIDown_ProxyReceptionInterface.h evDIUp_ProxyReceptionInterface.h evLeftShiftDown_ProxyReceptionInterface.h evLeftShiftUp_ProxyReceptionInterface.h evRightShiftDown_ProxyReceptionInterface.h evRightShiftUp_ProxyReceptionInterface.h evDIShifting_ProxyReceptionInterface.h evMechanicalShifting_ProxyReceptionInterface.h evDisplayGearing_ProxyReceptionInterface.h 
	@echo Compiling Pegasus_Test_Architecture.cpp
	@$(CC) $(ConfigurationCPPCompileSwitches)  -o Pegasus_Test_Architecture.o Pegasus_Test_Architecture.cpp
...
TestPkg.o : TestPkg.cpp TestPkg.h    Pegasus_Test_Architecture.h 
...
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) GearShiftingTestComponent.mak
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) GearShiftingTestComponent.mak
...
clean:
	...
	$(RM) ShiftLever.o
	$(RM) DIButton.o
	$(RM) Pegasus_Test_Architecture.o
