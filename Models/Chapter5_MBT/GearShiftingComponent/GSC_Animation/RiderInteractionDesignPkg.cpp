...
//!	Generated Date	: Sat, 28, Nov 2020  
	File Path	: GearShiftingComponent/GSC_Animation/RiderInteractionDesignPkg.cpp
*********************************************************************/
...
//## classInstance itsPegasus_System
...
//## classInstance itsPegasus_System
Pegasus_System itsPegasus_System;
...
void RiderInteractionDesignPkg_initRelations() {
    {
        {
            itsPegasus_System.setShouldDelete(false);
        }
    }
...
bool RiderInteractionDesignPkg_startBehavior() {
    bool done = true;
    done &= itsPegasus_System.startBehavior();
    return done;
}
...
static void RenameGlobalInstances() {
    OM_SET_INSTANCE_NAME(&itsPegasus_System, Pegasus_System, "itsPegasus_System", AOMNoMultiplicity);
}
#endif // _OMINSTRUMENT

//#[ ignore
RiderInteractionDesignPkg_OMInitializer::RiderInteractionDesignPkg_OMInitializer() {
